...
const WhatsAppButton = () => {
    const phoneNumber = '919703908232'; // International format
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2 group">
            ...
            <a
                ...
                className="transition-transform duration-300 hover:scale-110 animate-bounce-slow flex items-center justify-center"
                aria-label="Chat on WhatsApp"
            >
                <div className="bg-[#25D366] p-4 rounded-full shadow-2xl text-white">
                    <svg
